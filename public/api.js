...
/**
 * Function to fetch the authorization token from the server using axios.
 * 
...
async function GetAuthToken(username, password) {
  try {
      const response = await axios.post(`${settings.databaseServerUrl}${settings.authApiEndpoint}`, {
          username,
          password
      });

...
async function GetEquipmentListByTypeMOCK(equipmentType) {
  ...
  const equipmentMap = {
    balances: [
      { name: "balances", code: "007-1", description: "max=3kg; d=0.01g" },
      { name: "balances", code: "007-10", description: "max=2kg; d=0.01g"},
      { name: "balances", code: "007-12", description: "max=1kg; d=0.02g" },
      { name: "balances", code: "007-16", description: "max=220gkg; d=0.0001g" },
      { name: "balances", code: "007-21", description: "max=1.3kg; d=0.01g" },
      { name: "balances", code: "007-25", description: "max=3.5kg; d=0.01g" },
      { name: "balances", code: "007-26", description: "max=3.5kg; d=0.01g" },
      { name: "balances", code: "007-27", description: "max=3.5kg; d=0.01g" },
      { name: "balances", code: "007-34", description: "max=3.5kg; d=0.01g" },
      { name: "balances", code: "007-6", description: "max=10kg; d=0.1g" },
      { name: "balances", code: "007-20", description: "max=3kg; d=0.01g" },
      { name: "balances", code: "007-23", description: "max=150kg; d=0.05kg" },
      { name: "balances", code: "007-24", description: "max=30kg; d=0.1g" },
      { name: "balances", code: "007-39", description: "max=30kg; d=0.1g" },
      { name: "balances", code: "007-40", description: "max=30kg; d=0.1g" },
      { name: "balances", code: "007-41", description: "max=3kg; d=0.01kg" },
      { name: "balances", code: "007-42", description: "max=30kg; d=1.0g" },
      { name: "balances", code: "007-43", description: "max=1kg; d=0.02g" },
      { name: "balances", code: "007-44", description: "max=120kg; d=0.01kg" },
      { name: "balances", code: "007-45", description: "max=60kg; d=0.02kg" },
    ],
    reactor: [
